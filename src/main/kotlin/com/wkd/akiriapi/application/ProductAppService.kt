...
class ProductAppService(
    ...
    fun htmlParsingFrom29cm(doc: Document, url: String) : ProductParam {
        ...
        val originCategory = doc.select("span.e1lurd2z3:nth-child(2)").text()
        ...
        val param = ProductParam(
            ...
            title = title,
            imageUrl = imageUrl,
            category = ProductCategory.fromValueByIndex(originCategory),
    ...
    fun htmlParsingFromOhou(doc: Document, url: String) : ProductParam {
        ...
        val originCategory = doc.select("body > div.page > div > div > div.production-selling > div.production-selling-overview.container > nav > ol > li:nth-child(1) > a").text()
